/**
 * Full-text preview cache (IndexedDB). File contents for the explorer preview are read from disk
 * on demand when a directory handle exists; this cache backs previews after reload or for folder
 * upload flows so every indexed text file can open like an IDE, independent of AI snapshot size.
 */

import { readFileAsUtf8Limited, wantFileBody, PREVIEW_MAX_BYTES } from './projectSnapshot.js'
